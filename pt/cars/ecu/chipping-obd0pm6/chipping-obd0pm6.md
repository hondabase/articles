...
> [!NOTE]
> Se tiver uma ECU de modelo antigo de 1988–1989, consulte o guia especializado de [Alteração de ECUs OBD0 antigas](/cars/honda/civic/ef/ecu/chipping-an88-89ecu) para obter instruções sobre como adicionar o hardware necessário.
