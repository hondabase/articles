...
Construa o módulo primeiro usando o [guia de montagem do Easy-RTP v1.0](/cars/tuning/easy-rtp-v10). A fonte assume que as placas OBD1 são semelhantes, mas apenas mostra uma instalação numa P28 e lista separadamente pinos diferentes para uma P30-900 JDM de montagem em superfície (surface-mount).
...
- [Guia de construção e instalação DIY do Easy-RTP v1.0](/cars/tuning/easy-rtp-v10)
