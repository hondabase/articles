---
summary: 'Fazer o "chipping" (ou chipar) de uma ECU significa substituir o programa que corre na ECU. "Chipping" é apenas calão. O que na verdade fazemos é programar (ou "gravar") um novo ficheiro .bin na ROM...'
applies_to:
  obd: [0]
