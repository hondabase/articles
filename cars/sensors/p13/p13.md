...
### Knock Sensor Bypass
> [!NOTE]
> If swapping an H22A into a chassis without a knock sensor, you must bypass the sensor check to avoid Error Code 23. Refer to the [Knock Sensor bypass guide](/cars/tuning/remove-a-knock-sensor).
