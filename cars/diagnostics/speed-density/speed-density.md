...
What is a [Speed Density](/cars/diagnostics/speed-density) engine managment scheme? [Speed Density](/cars/diagnostics/speed-density) systems calculate the amount of air entering a motor using sensors that monitor engine operating conditions. The [Ideal Gas Law](/cars/tuning/ideal-gas-law) (**PV = nRT**) is the basis for this type of engine management. Instead of directly measuring the amount of air entering the motor ("n" in the above equation), speed-density systems estimate it using **n = PV / RT**, and then applying additional corrections. Fuel tables in a honda [ECU](/cars/ecu/ecu) (from a theoretical standpoint) are Volumetric Efficiency (VE) tables. Basic operation:

- A [Map Sensor](/cars/fueling/map-sensor) is used to measure the pressure of air in the intake manifold (DENSITY term in speed-density). This provides the **P** term in the [Ideal Gas Law](/cars/tuning/ideal-gas-law) calulation.
- The engine's rotational speed (SPEED term in speed-density) is used to estimate the volume of air entering the motor by multiplying how much air is sucked into the cylinder `each` stroke (usually displacement divide by two) by the number of engine revolutions. This provides the **V** term in the [Ideal Gas Law](/cars/tuning/ideal-gas-law) calculation.
- The [Intake Air Temperature Sensor](/cars/sensors/intake-air-temperature-sensor) measures the temperature of air entering the engine, providing the **T** term in the [Ideal Gas Law](/cars/tuning/ideal-gas-law) calculation.
- **R** is a constant
