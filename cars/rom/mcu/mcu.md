---
summary: 'An overview of microcontroller (MCU) units used in Honda ECUs, defining their role as integrated CPUs with onboard memory and I/O facilities.'
tags: [ecu, reference, tuning, rom, sensors, mcu]
applies_to:
  obd: [0, 1, 2]
...
> [!NOTE]
> Detailed technical documentation regarding the specific MCUs utilized within Honda ECUs can be found in the [66k Assembler Documentation](/cars/diagnostics/66k-assembler-docs).