...
The **`28C256`** is a 32 KB (256-kilobit) parallel Electrically Erasable Programmable Read-Only Memory (EEPROM) chip. While it has the same memory capacity and uses the same physical 28-pin Dual In-line Package (DIP-28) as the standard [27C256 EPROM](/cars/electronics/27c256), their pinouts differ. 
