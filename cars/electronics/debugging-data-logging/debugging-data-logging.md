...
Before checking software settings, use a digital multimeter in **continuity (beep) mode** to verify the electrical traces surrounding the [CN2 datalogging header](/cars/electronics/serial-communication) on the ECU circuit board:
...
- [Configuring USB-to-TTL Adapters](/cars/electronics/second-gen-usb-to-serial-converter)
- [How to Interpret Sensor Diagnostics](/cars/electronics/honda-error-codes)
