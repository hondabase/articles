...
- [Knock Sensor](/cars/electronics/knock-sensor) - A microphone-like device to listen for Pre Ignition, or knocking in DOHC VTEC motors.
- Pa Sensor - Atmospheric Pressure sensor
- VTEC Solenoid = solenoid to route oil flow to activate VTEC (on VTEC motors only :) )

---

Other [ECU](/cars/electronics/ecu) Sensors not usually present on honda motors: - Maf Sensor
