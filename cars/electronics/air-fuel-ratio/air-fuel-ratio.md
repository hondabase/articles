...
Refer to the [tuning timing guide](/cars/electronics/tuning-timing) for details on calculating total ignition advance.

## Related Articles
- [Introduction to ECU Tuning](/cars/electronics/ecu-tuning)
- [How to Calibrate Spark Timing](/cars/electronics/tuning-timing)
- [Integrating a Wideband O2 Controller](/cars/electronics/wide-band-o2)
