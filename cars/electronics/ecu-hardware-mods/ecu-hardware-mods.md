...
Repurpose unused analog input pins on the ECU plug (such as the EGR Valve Lift Sensor pin or the EVAP Control pin) to datalog external 5V sensors like Exhaust Gas Temperature (EGT) probes or fuel pressure sending units. See the [How to Log External Data](/cars/electronics/how-to-log-external-data-such-as-an-egt-sensor) guide.
...
## 4. Hardware Sourcing
To find specific part numbers, package sizes, and electronic specifications for the resistors, transistors, and diodes required to execute these modifications, refer to the [ECU Parts Sourcing List](/cars/electronics/parts-for-ec-us).
