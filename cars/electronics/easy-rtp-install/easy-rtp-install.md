...
After the RTP hardware is installed, the archived page says an RS232-to-TTL converter is needed for ECU-to-PC communication. See the [Honda ECU datalogging overview](/cars/electronics/data-logging) and [serial communication guide](/cars/electronics/serial-communication) for the historical interface context.

## Related

- [DIY Easy-RTP v1.0 build and installation guide](/cars/electronics/easy-rtp-v10)
- [Honda ECU datalogging overview](/cars/electronics/data-logging)
- [OBD1 serial communication](/cars/electronics/serial-communication)
