...
[Text Formatting Rules](/cars/electronics/text-formatting-rules)***Emphasis:*** '____' for ''italics'', *''''* for ***bold***, '____'_''''_ for ''__both__'' ***Lists:*** * for bullet lists, # for numbered lists, "; term : definition" for definition lists ***References:*** !JoinCapitalizedWords or use square brackets for a [page link or URL [!http://cool.wiki.int/. ***Footnotes:*** Use [1,[2,[3,... ***Preventing linking*** Prefix with "!": !!DoNotHyperlink, name links like [text  (double up on the "[") ***Misc*** "!", "!!", "!!!" make headings, "%%''''%" makes a linebreak, "-''''-''''-''''-" makes a horizontal rule ---
...
- You can name the links by providing a name, a bar (|) and then the hyperlink or pagename: [PhpWiki home page ](http://phpwiki.sourceforge.net/) - the front page
...
- URLs ending with .png, .gif, or .jpg are inlined if in square brackets, by themselves: [http://phpwiki.sourceforge.net/alpha/themes/default/images/png.png](http://phpwiki.sourceforge.net/alpha/themes/default/images/png.png)
...
See [Magic Php Wiki URLs](/cars/electronics/magic-php-wiki-ur-ls) for gory details on how to write various kind of wiki maintainance links. ---
