...
***Note***: Most of the actions on this page require administrative privileges. They won't work unless you have set an admin username and password in the [Php Wiki](/cars/electronics/php-wiki) config file. ---

##  Cleanup 

A Wiki [Sand Box](/cars/electronics/sand-box) is very easy to clean. Here you can restore it to pristine condition by loading the default from pgsrc: Rake the Sand Box . ---
