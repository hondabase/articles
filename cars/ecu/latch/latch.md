...
## Functionality
Latches, such as the [74HC373](/cars/ecu/74hc373), act as transparent logic gates. When the enable signal is active, the output follows the input; when the enable signal is inactive, the output is "latched" or held at its last state regardless of changes to the input.
