...
> [!NOTE]
> If you are modifying a knock-equipped board to bypass the sensor check, refer to the [Knock Sensor Removal / Bypass](/cars/tuning/remove-a-knock-sensor) guide.
