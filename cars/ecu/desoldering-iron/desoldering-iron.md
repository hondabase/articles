...
> [!CAUTION]
> Squeezing the bulb while the iron is near the board is clumsy. If the tip slips, it can scratch the board mask or destroy copper traces. Always compress the bulb *before
